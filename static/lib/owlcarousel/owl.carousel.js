...
;(function($, window, document, undefined) {
		...
		this._handlers = {
			...
			'refreshed.owl.carousel': $.proxy(function(e) {
				if (e.namespace && this._core.is('resizing')) {
					this._core.$stage.find('.cloned .owl-videos-frame').remove();
				}
			}, this),
			'changed.owl.carousel': $.proxy(function(e) {
	...
	/**
	 * Gets the videos ID and the type (YouTube/Vimeo/vzaar only).
	 * @protected
	 ...
	 * @protected
	 * @param {jQuery} target - The target containing the videos data.
	 * @param {Object} info - The videos info object.
	 * @see `fetch`
	 */
		...
		var tnLink,
			...
			create = function(path) {
				...
				if (settings.lazyLoad) {
					...
					tnLink = '<div class="owl-videos-tn" style="opacity:1;background-image:url(' + path + ')"></div>';
				}
				target.after(tnLink);
				target.after(icon);
			};
	...
	Video.prototype.play = function(event) {
		...
		if (video.type === 'youtube') {
			...
			html = '<iframe src="//player.vimeo.com/videos/' + video.id +
		...
		$('<div class="owl-videos-frame">' + html + '</div>').insertAfter(item.find('.owl-videos'));

		this._playing = item.addClass('owl-videos-playing');
	};
